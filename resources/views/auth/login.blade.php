...
*/    .g-recaptcha{
    ...
    <br>
        ...
        <div class="field action">
             <button class="fluid" style="background: #ffc33d;color: #000">Log Masuk</button>
...
<!--
        @if(config('laravolt.platform.features.registration'))
            ...
            <div>
                <a themed href="{{ route('auth::registration.show') }}" class="link">Daftar disini</a>
            </div>
        @endif -->
        ...
        <div class="ui field m-b-2">
            <div class="ui equal width grid">
                <div class="column left aligned">
                    @if(config('laravolt.platform.features.registration'))
                   <div>
                        <font color="#004ca4" ><b>Tiada Akaun e-Perak? </b></font><a themed href="{{ route('auth::registration.show') }}" class="link"><font color="#004ca4" style="font-size: larger"><b>Daftar disini <i class="pen icon"></i></b></font></a>
                    </div>
                 @endif
                </div>
                <div class="column right aligned">
                     <a themed href="/" class="link"><font color="#004ca4"><b>Laman Utama <i class="home icon"></i></b></font></a>
                </div>
            </div>
        </div> -->
   </form>
