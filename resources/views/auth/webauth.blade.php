...
<body>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xs-12 col-md-6 col-md-offset-3 col-md-offset-3-right  ">
            <div class="card">
              <div class="card-header">@lang('messages.auth.title')</div>
              ...
              <div class="card-body">
                ...
                <h3 class="card-title">
                  ...
                  <p class="card-text">
                    @lang('messages.buttonAdvise')
                    <br />
                    @lang('messages.noButtonAdvise')
                  </p>

                <a href="/mobile" class="card-link" aria-pressed="true">@lang('messages.cancel')</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    var errors = {
      key_already_used: "@lang('errors.key_already_used')",
      key_not_allowed: "@lang('errors.key_not_allowed')",
      not_secured: "@lang('errors.not_secured')",
      not_supported: "@lang('errors.not_supported')",
    };
    ...
    webauthn.sign(
      ...
      function (datas) {
        ...
        window.location.href = "/mobile/logwebauth/{{ $id}}";
        // $('#form').submit();
      }
    );
  </script>
