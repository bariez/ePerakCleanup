<!DOCTYPE html>
<html lang="{{ config('app.locale') }}" data-font-size="{{ config('laravolt.ui.font_size') }}" style="font-size: 12px">
...
<head>
    ...
    <script type="text/javascript" src="{{ asset('chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js') }}">
    </script>
    ...
    <style>
        ...
        .sidebar .sidebar__accordion.ui.accordion .title.selected.empty,
        [data-theme=light] .sidebar .sidebar__accordion.ui.accordion .title:hover {
            background: #db9b2f;
        }

        [data-theme=light] .sidebar .sidebar__accordion.ui.accordion .title,
        [data-theme=light] .sidebar .sidebar__menu .brand {
            color: #ffffff;
        }

        [data-theme=light] .sidebar .sidebar__accordion.ui.accordion .title.selected.empty,
        [data-theme=light] .sidebar .sidebar__accordion.ui.accordion .title:hover {
            background: #be8e20;
            ;
        }
    ...
    <script type="text/javascript">
        function block(className) {
            ...
            var message =
                '<div class="intro-y grid grid-cols-6 sm:gap-6 gap-y-6 box px-5 py-8 mt-5 mb-5" id="indeterminate-linear-fee">';
