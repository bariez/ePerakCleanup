...
<body>
    ...
    <div>
        ...
        <main class="main"
            style="background-image: url('{{ asset('theme/assets/imgs/theme/perak/bgsix2.jpg') }}') !important;
 ...
 -->
    ...
    <script type="text/javascript" language="javascript" src="{{ asset('theme/assets/js/cdn/jquery.dataTables.min.js') }}">
    </script>
    <!-- <script type="text/javascript" language="javascript"
