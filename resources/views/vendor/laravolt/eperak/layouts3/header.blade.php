										...
										<!-- start icon ------------------------------------------------------------- -->
											<li class="signin">
												<a href="javascript:;" style="text-decoration: none; padding: 3px; padding-top: 10px; padding-right: 5px; ">
													<img src="{{ asset('theme/assets/imgs/theme/perak/wheelchair2.png') }}" alt="Bantuan" title="Bantuan" width="23" height="26">
												</a>
												<ul class="sub-menu">
													<li>
											...
											<li class="signin">
												<a href="/contactus" style="text-decoration: none; padding: 3px; padding-top: 10px; padding-right: 5px;">
													<img src="{{ asset('theme/assets/imgs/theme/perak/hubungi2.png') }}" alt="Hubungi Kami" title="Hubungi Kami" width="25" height="25">
												</a>
											</li>
											<li class="signin">
												<a href="/faq" style="text-decoration: none; padding: 3px; padding-top: 10px; padding-right: 5px;">
													<img src="{{ asset('theme/assets/imgs/theme/perak/faq2.png') }}" alt="Soalan Lazim" title="Soalan Lazim" width="25" height="25">
												</a>
											</li>
											<li class="signin">
												<a href="javascript:;" style="text-decoration: none; padding: 3px; padding-top: 10px; padding-right: 15px;">
													<img src="{{ asset('theme/assets/imgs/theme/perak/search2.png') }}" alt="Carian" title="Carian" width="23" height="26">
												</a>
												<ul class="sub-menu">
											...
											<li class="signin mr-5">
												@auth
													<div class="btn-group" role="group" aria-label="Basic example">
														<a href="/home" class="btn btn-default btn-shadow hover-up" style="color: white; background-color: #ce89b5">
															{{ data_get($roleuser, 'acl_roles.name') }}
														</a>
                                                        <a href="/auth/addlog/{{(auth()->user()->id)}}" class="btn btn-light btn-shadow hover-up" style="color: #ce89b5">LOG KELUAR</a>
													</div>
												@else
													<div class="btn-group" role="group" aria-label="Basic example">
														<a href="/auth/login" class="btn btn-default btn-shadow hover-up" style="color: white; background-color: #ce89b5">Log Masuk</a>
														<a href="/auth/register" class="btn btn-light btn-shadow hover-up" style="color: #ce89b5">Daftar</a>
