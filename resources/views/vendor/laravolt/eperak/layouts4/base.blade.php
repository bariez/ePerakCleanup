...
<html lang="{{ config('app.locale') }}" data-font-size="{{ config('laravolt.ui.font_size') }}">
	...
	<body>
		...
		<!-- Header Start -->
			@include('laravolt::eperak.layouts3.header')
		<!-- Header End   -->

		<!-- Mobile Menu Start -->
			@include('laravolt::eperak.layouts3.mobilemenu')
		<!-- Mobile Menu End   -->

		<!-- Content/Body Start -->
		<div>
			<!-- <main class="main" style="background-image: url('{{ asset('theme/assets/imgs/theme/perak/bgfour.png') }}') !important; background-size: 30% !important"> -->
			<main class="main" style="background-image: url('{{ asset('theme/assets/imgs/theme/perak/bgfive.png') }}') !important; 
		...
		<!-- Footer Start -->
		@include('laravolt::eperak.layouts3.footer')
		<!-- Footer End   -->
