	...
	<header class="header sticky-bar" style="background-image: url('{{ asset('theme/assets/imgs/theme/perak/headerbgthree.jpeg') }}') !important; background-size: cover; background-repeat: no-repeat; padding-top: 15px; padding-bottom: 15px; position: unset !important;">
					...
					<div class="header-nav">
						<nav class="nav-main-menu">
							<ul class="main-menu d-none d-sm-block">
								<li class="">
									<a class="active" href="/" id="mainmenu" style="font-weight: 900; padding-right: 10px !important">
										LAMAN UTAMA 
									</a>
								</li>
								<li>
									<a class="active" href="javascript:;" id="" style="font-weight: 900; padding-right: 0px !important; padding-left: 0px !important">
										|
									</a>
								</li>
								<li class="">
									<a href="/info" id="infomenu" style="font-weight: 900; padding-left: 10px !important; padding-right: 10px !important">
										INFO PETEMPATAN
									</a>
								</li>
								@foreach($page as $key => $pages)
									...
									<li class="">
										<a href="/page/{{ data_get($pages, 'menum.id') }}" class="pagemenuc" id="pagemenu{{ data_get($pages, 'id') }}"  
										   style="font-weight: 900; padding-right: 10px !important; padding-left: 10px !important">
					...
					<div class="block-signin">
						...
						<div class="header-nav" style="float: right;">
							<nav class="nav-main-menu d-none d-sm-block">
								<ul class="main-menu">
									<li class="signin">
										<a href="javascript:;" style="text-decoration: none; padding: 3px; padding-top: 10px">
									...
									<li class="signin mr-5">
										@auth
											<div class="btn-group" role="group" aria-label="Basic example">
												<!-- <button type="button" class="btn btn-default btn-shadow ml-10 hover-up">Daftar</button> -->
												<!-- <button type="button" class="btn btn-default btn-shadow ml-10 hover-up">Pentadbir Sistem</button> -->
												<a href="/home" class="btn btn-default btn-shadow hover-up" style="color: white">Pentadbir Sistem</a>
											</div>
										@else
											<div class="btn-group" role="group" aria-label="Basic example">
												<button type="button" class="btn btn-default btn-shadow ml-10 hover-up">Daftar</button>
												<!-- <button type="button" class="btn btn-default btn-shadow ml-10 hover-up">Log Masuk</button> -->
