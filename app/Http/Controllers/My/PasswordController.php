...
class PasswordController extends Controller
{
    ...
    public function update(Update $request): RedirectResponse
    {
        ...
        if (
            ...
            return redirect()->route('my::password.edit')->withSuccess(__('Kata Laluan Telah Dikemaskini') ?? '');
        }

        return redirect()->route('my::password.edit')->withError(__('Kata Laluan Tidak Sama') ?? '');
    }
}
