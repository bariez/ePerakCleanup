...
class CreateTaxLejarDetailCalendarTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tax_elejar_detail_calendar', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tax_elejar_detail_calendar');
    }
}
