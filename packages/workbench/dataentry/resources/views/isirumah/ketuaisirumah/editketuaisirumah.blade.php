 ...
 <h4 class="ui dividing header" style="color:black">Profil Ketua Isi Rumah</h4>
  <div class="two fields">
    <div class="field">
      ...
      <input type="text" name="name" id="name" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required" value="{{data_get($ketuaisirumah,'Nama')}}">
    </div>
    <div class="field">
      <label>Jenis Pengenalan<font color="red">*</font></label>
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="typepengenalan" id="typepengenalan" value="{{data_get($ketuaisirumah,'JenisPengenalan')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required">
  ...
  <div class="two fields">
    <div class="field" id="divnoic">
      ...
      <input max="14" name="noic" id="noic" type="text" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onKeyPress="if(this.value.length==12) return false;" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required" value="{{data_get($ketuaisirumah,'NoKP')}}">
    </div>
    <div class="field" id="divnopengenalan">
      <label>No. Tentera/No. Polis/Passport<font color="red">*</font></label>
      <input max="14" name="nopengenalan" id="nopengenalan" type="text" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required" value="{{data_get($ketuaisirumah,'NoKP')}}">
    </div>
    <div class="field" id="jantinapilih">
      <label id="labeljantina">Jantina<font color="red">*</font></label>
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="jantina" id="jantina" value="{{data_get($ketuaisirumah,'Jantina')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
    ...
    <div class="field" id="tlahircal">
      ...
      <div class="ui calendar" id="standard_calendar">
        <div class="ui input left icon">
          ...
          <input type="text" id="tarikhlahir" name="tarikhlahir" readonly="readonly" required="required" value="{{ date('d-m-Y', strtotime(data_get($ketuaisirumah,'TarikhLahir')))}}">
        </div>
      </div>
    </div>
    <div class="field" id="tlahircaledit">
      <label id="labellahiredit">Tarikh Lahir<font color="red">*</font></label>
      <div class="ui calendar" id="standard_calendaredit">
        <div class="ui input left icon">
          <i class="calendar icon"></i>
          <input type="text" id="tarikhlahiredit" name="tarikhlahiredit" readonly="readonly" required="required" value="">
        </div>
      </div>
    </div>
    <div class="field" id="tlahirauto">
      <label id="labellahirauto">Tarikh Lahir<font color="red">*</font></label>
      <input type="text" id="tarikhlahirauto" name="tarikhlahirauto" readonly="readonly" required="required" value="{{ date('d-m-Y', strtotime(data_get($ketuaisirumah,'TarikhLahir')))}}">
    </div>
    <div class="field">
  ...
  <div class="two fields">
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="bangsa" id="bangsa" value="{{ data_get($ketuaisirumah,'Bangsa') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
  ...
  <div class="two fields">
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="agama" id="agama" value="{{ data_get($ketuaisirumah,'Agama') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="taraf" id="taraf" value="{{ data_get($ketuaisirumah,'TarafKahwin') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
  ...
  <div class="two fields">
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="statuskerja" id="statuskerja" value="{{data_get($ketuaisirumah,'StatusPekerjaan') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
    ...
    <div class="field">
      ...
      <input type="text" name="kerja" id="kerja" required="required" value="{{ data_get($ketuaisirumah,'Pekerjaan') }}">
    </div>
  </div>
  <div class="two fields">
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="bantuanbulan" id="bantuanbulan" value="{{ data_get($ketuaisirumah,'PenerimaBantuan') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
    ...
    <div class="field">
      ...
      <input type="text" name="bantuanlain" id="bantuanlain" required="required" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " value="{{ data_get($ketuaisirumah,'BantuanLain') }}">
    </div>

  </div>
  <div class="two fields">
    <div class="field">
      <label>Id Rumah<font color="red">*</font></label>
      <input type="text" name="idrumah" id="idrumah" readonly="readonly" value="{{data_get($ketuaisirumah,'rumah.IdRumah')}}">
    </div>

    <div class="field">
      <label>Pendapatan Isi Rumah<font color="red">*</font></label>
      <input type="text" name="pendapat" id="pendapat" required="required" value="{{ data_get($ketuaisirumah,'Pendapatan') }}">
    </div>
  ...
  <div class="two fields">
    <div class="field">
      ...
      <input type="text" name="alamat1" id="alamat1" required="required" value="{{ data_get($ketuaisirumah,'rumah.AlamatRumah1') }}">
    </div>
    <div class="field">
      <label>Alamat 2<font color="red">*</font></label>
      <input type="text" name="alamat2" id="alamat2" required="required" value="{{ data_get($ketuaisirumah,'rumah.AlamatRumah2') }}">
    </div>
  ...
  <div class="two fields">
    <div class="field">
      ...
      <input type="text" name="poskod" id="poskod" value="{{data_get($ketuaisirumah,'rumah.Poskod')}}" onkeyup="this.value=this.value.replace(/[^\d]/,'')" required="required" onKeyPress="if(this.value.length==5) return false;">
    </div>
    <div class="field">
      <label>&nbsp;</label>
      <label>&nbsp;</label>
  ...
  <div class="two fields">
    ...
    <div class="field">
      ...
      <input type="text" name="notel" id="notel" onkeyup="this.value=this.value.replace(/[^\d]/,'')" required="required" value="{{data_get($ketuaisirumah,'TelNo')}}" onKeyPress="if(this.value.length==12) return false;">
    </div>
  </div>
  ...
  <div class="two fields"> 
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="statusmilik" id="statusmilik" value="{{data_get($ketuaisirumah,'rumah.StatusMilikan')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="jenisrumah" id="jenisrumah" value="{{data_get($ketuaisirumah,'rumah.JenisRumah')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
  ...
  <div class="two fields">
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="binaanrumah" id="binaanrumah" value="{{data_get($ketuaisirumah,'rumah.JenisBinaan')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="biltingkat" id="biltingkat" value="{{data_get($ketuaisirumah,'rumah.BilTingkat')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
  ...
  <div class="two fields">
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="bilbilik" id="bilbilik" value="{{data_get($ketuaisirumah,'rumah.BilBilik')}}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
        <i class="dropdown icon"></i>
        <div class="default text">Sila Pilih</div>
        <div class="menu">
          <div class="item" data-value="">Sila Pilih</div>
  ...
  <div class="two fields">
    ...
    <div class="field">
      ...
      <input type="text" name="Latitud" id="Latitud" required="required" value="{{data_get($ketuaisirumah,'rumah.Latitud')}}">
    </div>
    <div class="field">
      <label>Longitud<font color="red">*</font></label>
      <input type="text" name="Longitud" id="Longitud" required="required" value="{{data_get($ketuaisirumah,'rumah.Longitud')}}">
    </div>
  </div>
  ...
  <div class="two fields">
    <div class="field">
      <div class="inline fields">
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KElektrik')==1)
            <input type="radio" name="elektirk" tabindex="0" class="hidden" value="1" required="required" checked="checked">
            @else
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KElektrik')==0)
            <input type="radio" name="elektirk" tabindex="0" class="hidden" value="0" checked="checked">
            @else
    ...
    <div class="field">
      <div class="inline fields">
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KAir')==1)
            <input type="radio" name="paip" tabindex="0" class="hidden" value="1" required="required" checked="checked">
            @else
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KAir')==0)
            <input type="radio" name="paip" tabindex="0" class="hidden" value="0" checked="checked">
            @else
  ...
  <div class="two fields">
    <div class="field">
      <div class="inline fields">
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KTelefon')==1)
            <input type="radio" name="ktel" tabindex="0" class="hidden" value="1" required="required" checked="checked">
            @else
            <input type="radio" name="ktel" tabindex="0" class="hidden" value="1" required="required" checked="checked">
            @endif
            <label>Ada</label>
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KTelefon')==0)
    ...
    <div class="field">
      <div class="inline fields">
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KInternet')==1)
            <input type="radio" name="internet" tabindex="0" class="hidden" value="1" required="required" checked="checked">
            @else
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KInternet')==0)
            <input type="radio" name="internet" tabindex="0" class="hidden" value="0" checked="checked">
            @else
  ...
  <div class="two fields">
    <div class="field">
      <div class="inline fields">
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KAstro')==1)
            <input type="radio" name="astro" tabindex="0" class="hidden" value="1" required="required" checked="checked">
            @else
        ...
        <div class="field">
          <div class="ui radio checkbox">
            @if(data_get($ketuaisirumah,'rumah.KAstro')==0)
            <input type="radio" name="astro" tabindex="0" class="hidden" value="0" checked="checked">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var jenisbantuan = "{{data_get($ketuaisirumah,'PenerimaBantuan')}}"
    ...
    var jantina = "{{data_get($ketuaisirumah,'Jantina')}}";
    var jenis = "{{data_get($ketuaisirumah,'PenerimaBantuan')}}";
    ...
    if (type == 150) { //kad pengenalan
      ...
      $("#labellahirauto").html("Tarikh Lahir");
  ...
  function validateketua() {
    ...
    var datagambarexists = "{{$filexists}}";

    var emel = document.getElementById("emel").value;

    var email_reg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;

    if ((gambar == '' || gambar == null) && datagambarexists == false) {
      var gambarexsists = 0;
    } else {
      var gambarexsists = 1;
    }
    ...
    if (typepengenalan == '') {
      ...
      if (ic.length < 12 && typepengenalan == 150) {

        alert('Sila Masukan 12 digit No. Kad Pengenalan ')
