    ...
    <div class="ui attached segment">
        ...
        <div class="two fields">
            ...
            <div class="field" id="jantinapilih">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="jantina" id="jantina" value="{{ old('jantina') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            ...
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="bangsa" id="bangsa" value="{{ old('bangsa') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="agama" id="agama" value="{{ old('agama') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
            ...
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="taraf" id="taraf" value="{{ old('taraf') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            ...
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="statuskerja" id="statuskerja" value="{{ old('statuskerja') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="bantuanbulan" id="bantuanbulan" value="{{ old('bantuanbulan') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            ...
            <div class="field">
                ...
                <input type="text" name="poskod" id="poskod" onkeyup="this.value=this.value.replace(/[^\d]/,'')"
                    required="required" onKeyPress="if(this.value.length==5) return false;">
            </div>
        </div>
        ...
        <div class="two fields">
            ...
            <div class="field">
                ...
                <input type="text" name="notel" id="notel" onkeyup="this.value=this.value.replace(/[^\d]/,'')"
                    required="required" onKeyPress="if(this.value.length==12) return false;">
            </div>
        </div>
        ...
        <div class="two fields">
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="statusmilik" id="statusmilik" value="{{ old('statusmilik') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
            ...
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="jenisrumah" id="jenisrumah" value="{{ old('jenisrumah') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="binaanrumah" id="binaanrumah" value="{{ old('binaanrumah') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
            ...
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="biltingkat" id="biltingkat" value="{{ old('biltingkat') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
        ...
        <div class="two fields">
            <div class="field">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="bilbilik" id="bilbilik" value="{{ old('bilbilik') }}"
                        onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
