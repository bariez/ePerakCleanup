...
<table class="body-wrap" bgcolor="#f5f8fa" width="100%" style="border-collapse: collapse;">
	<tr>
		<td class="container" >
			...
			<p>
				Project {{$project_no}} {{$developer_name}} is due for commissioning in less than 30 day’s. Please conduct IOM meeting immediately. If IOM meeting has been conducted, please update IOM Meeting Date.</p>
