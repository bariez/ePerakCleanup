...
class DataentryController extends Controller
{
    ...
    public function addketua($idkampung)
    {
       ...
       // return view('dataentry::isirumah.ketuaisirumah.addketuaisirumah', compact('idkampung', 'jantina', 'warga', 'bangsa', 'agama', 'taraf', 'statuskerja', 'bantuanbulanan', 'statusmilik', 'jenisrumah', 'binaanrumah', 'biltingkat', 'bilbilik', 'jenispengenalan', 'Status', 'infokampung', 'KependudukanRumah', 'KeadaanRumah'));
    }
    ...
    public function editketua($idisirumah, $idkampung)
    {
      ...
      //  $filexists = file_exists(public_path(data_get($ketuaisirumah, 'rumah.Gambar_path')));
       ...
       // return view('dataentry::isirumah.ketuaisirumah.editketuaisirumah', compact('idisirumah',
          //  'ketuaisirumah', 'jantina', 'warga', 'bangsa', 'agama', 'taraf', 'statuskerja', 'bantuanbulanan', 'statusmilik', 'jenisrumah', 'binaanrumah', 'biltingkat', 'bilbilik', 'idkampung', 'jenispengenalan', 'Status', 'filexists', 'infokampung', 'KependudukanRumah', 'KeadaanRumah'));
    }
