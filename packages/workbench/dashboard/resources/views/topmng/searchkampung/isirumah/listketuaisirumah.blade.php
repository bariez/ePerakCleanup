        ...
        <div class="ui attached segment raised">
            <div align="right">
                ...
                @if (data_get($roleuser, 'role_id') == '1')
                    <a href='#' data-idkampung='{{ $idkampung }}' class='ui blue button btnimport'>
                        <i class="upload icon"></i><span>Import Data</span></a>
                @endif
                <a href="{!! URL::to('dataentry/searchkampung/cetakkirAll/1/' . $idkampung) !!}"class='ui yellow button'><i class="print icon"></i><span>Cetakan
                        KIR</span></a>
            </div>
            <br>
                ...
                <tbody>
                    ...
                    @forelse($ketuaisirumah as $key =>$data)
                        <tr style="text-align: center;">
                            ...
                            <td><a href="{!! URL::to('/dashboard/searchkampung/isirumah/viewketua/' . data_get($data, 'id') . '/' . $idkampung) !!}" data-tooltip="Paparan" data-position="bottom center"><i
                                        class="eye icon"></i></a>
                                <a href="{!! URL::to('/dashboard/searchkampung/isirumah/ahliisirumah/' . $idkampung . '/' . data_get($data, 'rumah.id')) !!}" data-tooltip="Ahli Isi Rumah"
