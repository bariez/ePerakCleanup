            ...
            <div class="ui segment p-3">
                <form class="ui form">
                  ...
                  @if(data_get($roleuser,'role_id')==2)
                       ...
                       <div class="field">
                          <label>Mukim</label>
                               <div class="ui fluid search selection dropdown" id="mukimselect">
                     ...
                     <div class="field">
                          <label>Daerah</label>
                              <div class="ui fluid search selection dropdown" id="daerahselect">
               ...
               <div class="two fields">
                     <div class="field">
                          <label>Parlimen</label>
                              <div class="ui fluid search selection dropdown" id="parlimenselect">
                     ...
                     <div class="field">
                          <label>Dun</label>
                               <div class="ui fluid search selection dropdown" id="dunselect">
                 ...
                 <div class="two fields">
                     <div class="field">
                          <label>Kategori Petempatan</label>
                              <div class="ui fluid search selection dropdown" id="katselect">
                     ...
                     <div class="field">
                          <label>Nama Kampung</label>
                               <div class="ui fluid search selection dropdown" id="kampungselect">
