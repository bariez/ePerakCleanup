  ...
  function getPieJenisRumah(arr_jenis, arr_data, lengthdata, jumjenisrumah) {
    ...
    function getRandomColorEachData(count) {
      ...
      var arr_color = [
        ...
        // ]
          ["#355070", "#6D597A", "#915F78", "#B56576", "#CD6873", "#E56B6F", "#EAAC8B", "#ECB496",
        ],
        // [
    ...
    if (lengthdata == 0) {
      ...
      var barChartData = {
        ...
        datasets: [{
            ...
            backgroundColor: "rgb(145, 95, 120)",
            hoverBackgroundColor: "rgb(145, 95, 120)",
            data: arr_ya
          },
          {
            label: "Tidak",
            //backgroundColor: getRandomColorEachData(1),
            backgroundColor: "rgb(205, 104, 115)",
            hoverBackgroundColor:"rgb(205, 104, 115)",
            data: arr_tidak
          }
        ]
      };
