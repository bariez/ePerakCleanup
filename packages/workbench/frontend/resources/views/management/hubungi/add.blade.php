...
<!-- <style>
	...
	<div class="ui attached segment">
		...
		{!! form()->open()->post()->action(route('site::frontendmanage.postHubungiSaveAdd'))->attribute('id', 'formaddcontactus')->multipart()->horizontal() !!}
		 <!-- Form::open()->url('/site/hubungi/save')->method('POST')->class('ui form horizontal')->multipart(); !!} -->
			...
			<div class="field" id="selphone">
				...
				<input type="number" name="phone" id="idphone" minlength="10" maxlength="12"
			...
			<div class="field" id="selfaks">
				...
				<input type="number" name="faks" id="idfaks" minlength="10" maxlength="12"
					   placeholder="No Faks" 
					   onkeypress="onlynumber(event)">
			</div>
			...
			<div class="field" id="selemel">
				...
				<input type="text" name="emel" id="idemel" 
					   placeholder="Emel" >
			</div>
