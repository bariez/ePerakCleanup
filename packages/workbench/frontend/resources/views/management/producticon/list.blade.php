...
<!-- <style>
	...
	<h4 class="ui top attached header">
		Senarai Ikon Kategori Produk
	</h4>

	<div class="ui attached segment">
		<table id="listiconproduk" class="ui celled table" style="width:100%">
			<thead>
				<tr>
			...
			<tbody>
				...
				@forelse($data as $key =>$value)
					<tr  style="text-align: center;">
						<td>{{ $i }}</td>
						<td>{{ data_get($value, 'lkp_detail.description') }}</td>
						<td>
							<img src="{!! URL::to(data_get($value,'path')) !!}" alt="{{ data_get($value,'alt') }}" style="width:100px">
						</td>
						<td>
							@if($value->status == '1')
								Aktif
						...
						<td>
							<a href="{!! URL::to('/site/katprod/edit/'.data_get($value,'id')) !!}">
								<i class="edit icon"></i>
							</a>
						</td>
					</tr>
				...
				@empty
					<tr>
						<td colspan='5' class="center aligned">Tiada Data</td>
					</tr>
				@endforelse
			</tbody>
		</table>
