...
<!-- <style>
	...
	<h4 class="ui top attached header">
		Tambah Ikon Kategori Produk
	</h4>

	<div class="ui attached segment">

		{!! form()->open()->post()->action(route('site::frontendmanage.postProductIconSaveAdd'))->attribute('id', 'formaddproducticon')->multipart()->horizontal() !!}
		 <!-- Form::open()->url('/site/katprod/save')->method('POST')->class('ui form horizontal')->multipart(); !!} -->

			<div class="field" id="selkatprod">
				<label>Kategori Produk<span style="color: red">&nbsp;*</span></label>
				<div class="ui fluid search selection dropdown">
					<input type="hidden" name="katprod" id="idkatprod" required="required">
