...
<!-- <style>
	...
	<div class="ui attached segment">
		...
		{!! form()->open()->post()->action(route('site::frontendmanage.postPageSaveAdd'))->attribute('id', 'formaddpage')->multipart()->horizontal() !!}
		 <!-- Form::open()->url('/site/page/save')->method('POST')->class('ui form horizontal')->multipart(); !!} -->

			<div class="field" id="selfkmenu">
				<label>Menu<span style="color: red">&nbsp;*</span></label>
				<div class="ui fluid search selection dropdown">
					<input type="hidden" name="fkmenu" id="idfkmenu" required="required">
