...
<!-- <style>
	...
	<div class="ui attached segment">
		...
		{!! form()->open()->post()->action(route('site::frontendmanage.postNotisSaveAdd'))->attribute('id', 'formaddnotis')->multipart()->horizontal() !!}
		 <!-- Form::open()->url('/site/notis/save')->method('POST')->class('ui form horizontal')->multipart(); !!} -->
			...
			<div class="field" id="selsummary">
				...
				<input type="text" name="summary" id="idsummary" 
