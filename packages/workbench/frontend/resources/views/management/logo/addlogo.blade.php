...
<!-- <style>
	...
	<div class="ui attached segment">
		...
		{!! form()->open()->post()->action(route('site::frontendmanage.postLogoSaveAdd'))->attribute('id', 'formaddlogo')->multipart()->horizontal() !!}
		<!-- Form::open()->url('/site/logo/savelogo')->method('POST')->class('ui form horizontal')->multipart(); !!} -->

			<div class="field" id="selinfo">
				<label>Informasi<span style="color: red">&nbsp;*</span></label>
				<input type="text" name="info" id="idinfo" placeholder="Informasi" 
			...
			<div class="field" id="seltype">
				...
				<div class="ui fluid search selection dropdown">
					<input type="hidden" name="type" id="idtype" required="required">
			...
			<div class="field" id="selstatus">
				...
				<div class="ui fluid search selection dropdown">
					<input type="hidden" name="status" id="idstatus" required="required">
					<i class="dropdown icon"></i>
					<div class="default text">Sila Pilih</div>
					<div class="menu">
						<div class="item" data-value="">Sila Pilih</div>
