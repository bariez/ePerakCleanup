...
<!-- <style>
	...
	<h4 class="ui top attached header">
		Tambah Menu Laman Utama
	</h4>

	<div class="ui attached segment">

		{!! form()->open()->post()->action(route('site::frontendmanage.postMenuSaveAdd'))->attribute('id', 'formaddmenu')->multipart()->horizontal() !!}
		 <!-- Form::open()->url('/site/menu/save')->method('POST')->class('ui form horizontal')->multipart(); !!} -->
