...
<!-- <style>
	...
	<div id="actionbar" class="ui two column grid content__body p-x-3 p-y-1 m-b-0" >
		...
		<div class="column right aligned middle aligned">
			<a class="ui button green" href="{!! URL::to('site/menu/add') !!}">
	...
	<h4 class="ui top attached header">
		Senarai Menu Laman Utama
	</h4>

	<div class="ui attached segment">
		<table id="listmenu" class="ui celled table" style="width:100%">
			<thead>
				<tr>
			...
			<tbody>
				...
				@forelse($data as $key => $value)
					<tr  style="text-align: center;">
						...
						<td>
							<a href="{!! URL::to('/site/menu/edit/'.data_get($value, 'id')) !!}">
								<i class="edit icon"></i>
							</a>
						</td>
					</tr>
