...
<!-- <style>
	...
	<div class="ui attached segment">
		<table id="listfaq" class="ui celled table" style="width:100%">
			<thead>
				<tr>
			...
			<tbody>
				...
				@forelse($data as $key => $value)
					<tr  style="text-align: center;">
						<td>{{ $i }}</td>
						<td>{{ data_get($value, 'Soalan') }}</td>
						<td>{{ data_get($value, 'Jawapan') }}</td>
						...
						<td>
							<a href="{!! URL::to('/site/soalan/edit/'.data_get($value, 'id')) !!}">
								<i class="edit icon"></i>
							</a>
						</td>
					</tr>
