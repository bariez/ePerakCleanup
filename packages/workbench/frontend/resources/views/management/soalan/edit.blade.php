...
<!-- <style>
	...
	<div class="ui attached segment">
		...
		{!! form()->open()->post()->action(route('site::frontendmanage.postSoalanSaveEdit'))->attribute('id', 'formeditsoalan')->multipart()->horizontal() !!}
		 <!-- Form::open()->url('/site/soalan/saveedit/'.data_get($data, 'id'))->method('POST')->class('ui form horizontal')->multipart(); !!} -->
		<input type="hidden" name="soalan_id" id="soalan_id" value="{{ data_get($data, 'id') }}" >
			...
			<div class="field" id="selquestion">
				...
				<textarea type="textarea"
						  ...
						  name="question" 
						  placeholder="Soalan" 
						  id="idquestion" >{{ data_get($data, 'Soalan') }}</textarea>
			</div>
			...
			<div class="field" id="selanswer">
				...
				<textarea type="textarea"
						  ...
						  name="answer" 
						  placeholder="Jawapan" 
						  id="idanswer" >{{ data_get($data, 'Jawapan') }}</textarea>
			</div>
