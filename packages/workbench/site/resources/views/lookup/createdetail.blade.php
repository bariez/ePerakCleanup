...
<div id="actionbar" class="ui two column grid content__body p-x-3 p-y-1 m-b-0">
 ...
 <div class="column right aligned middle aligned">
           ...
           <a class="ui button" href="/site/lookup/index" id="backbutton"><i class="material-icons left" ></i><span>Kembali</span></a>
    </div>
...
<div class="ui container-fluid content__body p-3">
                ...
                <div class="ui menu secondary borderless m-0 p-0" style="min-height: 0">
                    <div class="item p-0 m-0">
                        <h4 class="panel__title ui header p-x-sm p-y-0">
                            <i class="pencil alternate icon"></i> Tambah Data Lookup 
                        </h4>
                    </div>
        ...
        {!! form()->open()->post()->action(route('site::lkpdetail.storedetail'))->horizontal() !!}
        ...
        <div class="field">
          ...
          <div class="field">
            ...
            <input type="text" name="description" id="description" required="required"  value="{{ old('description') }}">
          </div>
           <div class="field">
