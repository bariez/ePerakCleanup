    ...
    <tbody>
      ...
      <tr>
       ...
       <tr>
        ...
        <tr>
        <td class="gray">{{auth()->user()->security_token}}</td>
       </tr>
        <tr>
        <td>&nbsp;</td>
       </tr>
