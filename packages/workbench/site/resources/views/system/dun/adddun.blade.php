...
{!! form()->open()->post()->action(route('site::dun.savedun'))->attribute('id', 'formstruk')->multipart()->horizontal() !!}
         ...
         <div class="field">
          ...
          <div class="field">
           ...
           <div class="field">
            ...
            <input type="text"  name="ahli" id="ahli" required="required" value="{{ old('ahli') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();" required="required">
          </div>
          <div class="field">
