...
{!! form()->open()->post()->action(route('site::mukim.saveeditmukim'))->attribute('id', 'formstruk')->multipart()->horizontal() !!}
<input type="hidden" name="idmukim" id="idmukim" value="{{$id}}" >


           <div class="field">
              <label>Nama Daerah<font color="red">*</font></label>
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="daerah" id="daerah" value="{{ data_get($mukim,'fk_daerah') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
           ...
           <div class="field">
            ...
            <input type="text"  name="KodMukim" id="KodMukim" required="required" value="{{data_get($mukim,'KodMukim') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();">
          </div>
          <div class="field">
            <label>Nama Mukim<font color="red">*</font></label>
            <input type="text"  name="nama" id="nama" required="required" value="{{data_get($mukim,'NamaMukim') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();">
          </div>
          <div class="field">
            <label>Nama Penghulu Mukim<font color="red">*</font></label>
            <input type="text"  name="namapenghulu" id="namapenghulu" required="required" value="{{data_get($mukim,'NamaPenghuluMukim') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();">
          </div>
         
          <div class="field">
              <label>Status<font color="red">*</font></label>
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="status"  id="status" required="required" value="{{ data_get($mukim,'Status') }}">
                    <i class="dropdown icon"></i>
                    <div class="default text">Sila Pilih</div>
                    <div class="menu">
                      <div class="item" data-value="">Sila Pilih</div>
    ...
    <input type="text" name="urlgis" id="urlgis" value="{{data_get($mukim,'url_gis') }}">
  </div>
    <div class="field">
    <label>&nbsp;</label>
