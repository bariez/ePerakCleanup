...
{!! form()->open()->post()->action(route('site::parlimen.saveparlimen'))->attribute('id', 'formstruk')->multipart()->horizontal() !!}
         ...
         <div class="field">
          ...
          <div class="field">
           ...
           <div class="field">
            ...
            <input type="text"  name="parti" id="parti" required="required" value="{{ old('parti') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();">
          </div>
           <div class="field">
            <label>Ahli Parlimen<font color="red">*</font></label>
            <input type="text"  name="ahli" id="ahli" required="required" value="{{ old('ahli') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();">
          </div>
          <div class="field">
            <label>Jawatan<font color="red">*</font></label>
            <input type="text"  name="jawatan" id="jawatan" value="{{ old('jawatan') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();" required="required">
          </div>
           <div class="field">
            <label>Alamat Pejabat<font color="red">*</font></label>
            <input type="text"  name="alamat" id="alamat" value="{{ old('alamat') }}" onkeyup="this.value = this.value.toUpperCase();" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required">
          </div>
          <div class="field">
            <label>No Tel. Pejabat<font color="red">*</font>(Sila masukkan format nombor sahaja. Tanpa "-" atau jarak. Contoh: 0123456789))</label>
            <input type="text"  name="notel" id="notel" value="{{ old('notel') }}" onkeyup="this.value=this.value.replace(/[^\d]/,'')" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required" onKeyPress="if(this.value.length==12) return false;">
          </div>
           <div class="field">
            <label>Faksimili<font color="red">*</font>(Sila masukkan format nombor sahaja. Tanpa "-" atau jarak. Contoh: 0123456789))</label>
            <input type="text"  name="faks" id="faks" value="{{ old('faks') }}"onkeyup="this.value=this.value.replace(/[^\d]/,'')" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " required="required" onKeyPress="if(this.value.length==12) return false;">
          </div>
          <div class="field">
            <label>Emel<font color="red">*</font></label>
            <input type="text"  name="email" id="email"  value="{{ old('nama') }}" required="required">
          </div>
          <div class="field">
         ...
         <div class="field">
            <label>Gambar<font color="red">*</font></label>
             <button type="button" style="display:block;width:20px; height:40px;" onclick="document.getElementById('getFile').click()">Pilih Fail</button>
                <input type='file' id="getFile" name="gambar" value="{{ old('gambar') }}" style="width: 700px;height: 40px;" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') ">
              </div>
              <div class="field">
                 <label>&nbsp;</label>
