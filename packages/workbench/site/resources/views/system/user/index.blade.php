    ...
    <div class="sidebar-content">
      <div class="sidebar-header">
        <div class="sidebar-details">
          <h5 class="m-0 sidebar-title" style="color:purple"><i class="material-icons app-header-icon text-top">perm_identity</i> User <a class="ml-6 btn-floating waves-effect waves-light blue accent-2 btn-small" href="/admin/useradd" id="addbutton"><i class="material-icons">add_circle</i>ADD </a>
          </h5>
          </h5>
