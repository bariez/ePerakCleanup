...
<div id="actionbar" class="ui two column grid  p-x-3 p-y-1 m-b-0" >
    ...
    <div class="column right aligned middle aligned">
           ...
           <a class="ui button green" href="{!! URL::to('site/daerah/adddaerah') !!}" id="addbutton"><i class="icon plus"></i><span>Tambah</span></a>
...
<div class="ui attached segment raised">
            	...
            	<table id="listdaerah" class="ui celled table" style="width:100%">
                        <thead>
                            <tr>
                                <th style="text-align: center;">Bil</th>
                                <th style="text-align: center;">Kod Daerah</th>
                                <th style="text-align: center;">Nama Daerah</th>
                                <th style="text-align: center;">Nama Pegawai Daerah</th>
                         ...
                         <tbody>
                           <?php $i=1; ?>
                           @forelse($daerah as $key =>$data)
                             <tr  style="text-align: center;">
                                 <td>{{$i}}</td>
                                 <td>{{data_get($data,'KodDaerah')}}</td>
                                 <td>{{data_get($data,'NamaDaerah')}}</td>
                                 <td>{{data_get($data,'NamaPegawaiDaerah')}}</td>
