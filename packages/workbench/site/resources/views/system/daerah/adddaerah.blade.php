...
<div class="ui attached segment">
  {!! form()->open()->post()->action(route('site::daerah.savedaerah'))->attribute('id', 'formstruk')->multipart()->horizontal() !!}
  ...
  <div class="field">
    ...
    <input type="text" name="namapegawai" id="namapegawai" required="required" value="{{ old('namapegawai') }}" onchange="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Medan ini Wajib') " onkeyup="this.value = this.value.toUpperCase();">
  </div>
